<template>
  <div class="panel-tab__content">
    ...
    <div class="element-drawer__button">
      <el-button type="primary" @click="openListenerForm(null)">添加监听器</el-button>
    </div>
    ...
    <el-dialog title="字段配置" v-model="listenerFieldFormModelVisible" width="600px" append-to-body destroy-on-close>
      <el-form :model="listenerFieldForm" label-width="96px" ref="listenerFieldFormRef" style="height: 136px" @submit.prevent>
