      ...
      <template v-if="!$slots['control-header']">
        <el-button-group key="file-control">
          ...
          <el-tooltip effect="light">
            <template #content>
              <el-button :size="headerButtonSize" type="primary" link @click="downloadProcessAsBpmn()">下载BPMN</el-button>
              <br />
              <el-button :size="headerButtonSize" type="primary" link @click="downloadProcessAsSvg()">下载图片</el-button>
            </template>
            <el-button :size="headerButtonSize" :type="headerButtonType" :icon="Download">下载文件</el-button>
          </el-tooltip>
          <el-button :size="headerButtonSize" :type="headerButtonType" :icon="View" @click="previewProcessXML">预览</el-button>
        ...
        <el-button-group key="file-control">
          <el-button :size="headerButtonSize" :type="headerButtonType" :icon="RefreshRight" @click="processSave">保存</el-button>
        </el-button-group>
      </template>
      <!-- 用于打开本地文件-->
...
export default {
  ...
  emits: ["destroy", "init-finished", "save-flowable", "commandStack-changed", "update:modelValue", "change", "canvas-viewbox-changed", "element-click"],
  props: {
  ...
  methods: {
    ...
    async createNewDiagram(xml) {
      ...
      let newName = this.processName || `流程_${new Date().getTime()}`;
